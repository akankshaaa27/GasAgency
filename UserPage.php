...
<style>
    ...
    <body>
        ...
        <div class="container-fluid" style="background-image:url(images/bg3.png); height: 100vh; background-size: cover; background-position: center;">
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="col-md-6">
					...
					<!--<a class="btn btn-default btn-lg myBtn" href="complaints.html" style=" font-family: sans-serif;  width: 50%; font-size: 40px; margin: 25%; "><span class="fa fa-bolt"></span>        Complaints</a>--> 
